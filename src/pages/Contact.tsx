          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <Card>
              <CardHeader>
                ...
                <p className<dyad-problem-report summary="7 problems">
<problem file="src/pages/Index.tsx" line="6" column="26" code="2307">Cannot find module '@/data/services' or its corresponding type declarations.</problem>
...
<problem file="src/pages/Services.tsx" line="7" column="38" code="2307">Cannot find module '@/data/services' or its corresponding type declarations.</problem>
<problem file="src/pages/Testimonials.tsx" line="6" column="30" code="2307">Cannot find module '@/data/testimonials' or its corresponding type declarations.</problem>
...
I'll fix all the TypeScript errors by creating the missing files and updating the imports.
